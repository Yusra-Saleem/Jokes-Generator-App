...
export default function RandomJokeComponent() {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-[url('https://cdn.pixabay.com/photo/2016/01/25/15/17/bath-1160828_640.jpg')] bg-no-repeat bg-cover p-4">
